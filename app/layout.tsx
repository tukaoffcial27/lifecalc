  ...
  return (
    <html lang="en">
      ...
      <body className={`${inter.className} bg-[#FCFBFA] text-black font-medium antialiased`}>
        ...
        <div className="fixed top-0 right-0 w-[75%] md:w-80 h-full bg-[#C5A059] z-[100] translate-x-full peer-checked:translate-x-0 transition-transform duration-500 ease-in-out md:hidden shadow-[-25px_0_50_rgba(0,0,0,0.5)] border-l-2 border-black/20">
        ...
        <main className="pt-16 md:pt-20 min-h-screen">
          ...
          {/* UNIT IKLAN ADSENSE (Ditempatkan di bawah konten utama) */}
